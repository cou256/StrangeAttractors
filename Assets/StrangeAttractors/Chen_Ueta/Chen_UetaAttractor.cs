...
public class Chen_UetaAttractor : MonoBehaviour
{
    [SerializeField] float a = 35.0f;
    [SerializeField] float b = 3.0f;
    [SerializeField] float c = 28.0f;
    ...
    void KernelUpdate(float dt)
    {
        ...
        kernel.SetFloat("_B", b);
        kernel.SetFloat("_C", c);
